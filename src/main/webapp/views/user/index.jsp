			...
			<c:forEach items="${videos }" var="video">
				<div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-5">
					...
					<h5 class="tm-text-secondary"
						style="white-space: nowrap; overflow: hidden;">${video.title }
					</h5>
					<figure class="effect-ming tm-video-item">
						<img src="<c:url value='https://img.youtube.com/vi/${video.href}/maxresdefault.jpg'/>"alt="Image" class="img-fluid">
						<figcaption
